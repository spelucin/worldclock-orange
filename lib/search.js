import { searchLocations } from "./data.js";

export function createSearch({ onPick, placeholder = "Buscar ciudad o zona horaria…" }) {
  let root;
  ...
  function renderResults() {
    ...
    items.forEach((item, index) => {
      ...
      main.querySelector(".search-result-sub").textContent = item.country || item.region;
